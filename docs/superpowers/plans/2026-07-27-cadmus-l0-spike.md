...
- [ ] **Step 2: Provide the input image and generate goldens**

Place a real scanned page at `testdata/golden/input/scan.png` — a grayscale scan
of printed text, roughly 1000x1400 at 150dpi. Any scanned document page works;
commit it (it is input, not a generated artifact, and `.gitignore` only excludes
`testdata/corpus/images/`).
